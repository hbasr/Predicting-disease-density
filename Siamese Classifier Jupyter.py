...
get_ipython().system('git clone https://github.com/surmenok/keras_lr_finder')
get_ipython().system('mv keras_lr_finder/keras_lr_finder/* .')
...
get_ipython().system('wget https://github.com/fchollet/deep-learning-models/releases/download/v0.4/xception_weights_tf_dim_ordering_tf_kernels_notop.h5')
...
lr_finder.find_generator(train_gen(), 0.00001, 1, epochs=5, steps_per_epoch=training_steps)
